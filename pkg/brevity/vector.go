...
type VectorResponse struct {
	...
	Vector *Vector
	// BRA is the bearing, range, and altitude to an aircraft. Only set when the location is an aircraft such as a tanker.
	BRA *BRA
	// Track is the aircraft's track direction. Only set when the location is an aircraft such as a tanker.
	Track Track
}
