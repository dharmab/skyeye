...
func NoLaterThanCommitRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 65 * unit.NauticalMile
	}
	return 55 * unit.NauticalMile
}
...
func MeldAndSortRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 45 * unit.NauticalMile
	}
	return 32 * unit.NauticalMile
}
...
func MinimumOutRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 23 * unit.NauticalMile
	}
	return 13 * unit.NauticalMile
}
...
func MinimumReattackRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 16 * unit.NauticalMile
	}
	return 11 * unit.NauticalMile
}
...
func LastShotRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 14 * unit.NauticalMile
	}
	return 9 * unit.NauticalMile
}
...
func MinimumAbortRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 12 * unit.NauticalMile
	}
	return 8 * unit.NauticalMile
}
...
func SternWeaponEngagementZone(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 7 * unit.NauticalMile
	}
	return 4 * unit.NauticalMile
}
...
func DefensiveFlowRange(tc ThreatClass) unit.Length {
	if tc == SAR2OrAR1 {
		return 28 * unit.NauticalMile
	}
	return 18 * unit.NauticalMile
}
