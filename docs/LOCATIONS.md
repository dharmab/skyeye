...
You can define custom locations which players can reference in VECTOR requests. You can use this to define useful locations like airbases and other points of interest.
